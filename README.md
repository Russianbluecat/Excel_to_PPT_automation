...
### Slide 1
| PPT Object | Excel Range | Type | Description |
|------------|-------------|------|-------------|
| Slide_1_Text_01 | A5 | 텍스트박스 | 제목 |
| Slide_1_Pie_01 | A9:B12 | 파이 차트 | 제품별 매출 비중 |
| Slide_1_Bar_01 | A16:C20 | 막대 차트 | 연도별 비교 |
| Slide_1_Text_02 | A24:G25 | 표 (2행 6열) | 제품별 주문 수 |

### Slide 2
| PPT Object | Excel Range | Type | Description |
|------------|-------------|------|-------------|
| Slide_2_Text_01 | A33 | 텍스트박스 | 제목 |
| Slide_2_Line_01 | A37:D41 | 선 차트 | 국가별 트렌드 |
| Slide_2_Bar_01 | A44:C48 | 막대 차트 | 제품별 비교 |
